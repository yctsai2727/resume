...
{\begin{itemize}
  \item In this project we particularly focus on developping efficient methods for visualizing the Lagrangian Coherent Structure. Several approaches have been studied including the traditional Finite time Lyapuonv Exponent, Clustering approach and also comparison between local trajectories. 
\end{itemize}
}
}\enspace\\
